...
export const MAIN_HELP_MESSAGE =
  ...
  chalk.cyan(
    chalk.bold("Commands:\n\n"),
    chalk.bold("  find"),
    "          Search for a specific quest in the repo\n",
    chalk.bold("  test"),
    "          Run local tests for the current quest\n",
    chalk.bold("  submit"),
    "        Submit quest to nodeguardians.io for verification\n",
    chalk.bold("  update"),
    "        Update Questplay to the latest version\n",
    chalk.bold("  bridge"),
    "        Query the bridge signer for a signature\n",
    chalk.bold("  set-framework"),
    " Set default framework for local tests\n\n"
  ) +
  chalk.cyan(
    chalk.bold("Options:\n\n"),
    chalk.bold("  --help"),
...
export const TEST_HELP_MESSAGE =
  ...
  chalk.cyan(
    chalk.bold("index:"),
    "    Part of quest to test (e.g. 1, 2, 3)\n"
  );
...
export const FIND_HELP_MESSAGE =
  ...
  chalk.cyan(
    chalk.bold("name:"),
    "    (Optional) Name of quest to find. [hyphenated, no spacing]\n"
  );
...
export const SUBMIT_HELP_MESSAGE =
  ...
  chalk.cyan(
    chalk.bold("--set-upstream:"),
    "    (Optional) Push a new branch upstream\n"
  );

export const UPDATE_HELP_MESSAGE = chalk.gray(
  "\nUsage: quest update \n" + "\nUpdate Questplay to the latest version.\n"
);
...
export const BRIDGE_HELP_MESSAGE =
  ...
  chalk.cyan(
    chalk.bold("bridge-hash:"),
    "    32-byte bridge hash obtained from quest's contract\n"
  );
